...
public class ItemCardapio implements Serializable {
	...
	@NotNull
	@ManyToOne
	@JoinColumn(name = "restaurante_id") //nome da coluna de item_cardapio que e a FK de Restaurante
	private Restaurante restaurante;
	
	@UploadConstraint(acceptedTypes = FileType.PNG, message = "O arquivo nao e um arquivo de imagem valido")
