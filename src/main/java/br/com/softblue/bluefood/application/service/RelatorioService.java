...
public class RelatorioService {
	...
	public List<RelatorioItemFaturamento> calcularFaturamentoItens(Integer restauranteId, RelatorioItemFilter filter) {
		...
		if (itemId != 0) {
			itensObj = pedidoRepository.findItensPorFaturamento(restauranteId, itemId, dataHoraInicial, dataHoraFinal);
		} else {
			itensObj = pedidoRepository.findItensPorFaturamento(restauranteId, dataHoraInicial, dataHoraFinal);
		}
