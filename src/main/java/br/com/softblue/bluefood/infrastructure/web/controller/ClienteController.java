...
public class ClienteController {
	...
	public String viewRestaurante(@RequestParam("restauranteId") Integer restauranteId,
		...
		if (categoria == null) {
			...
			itensCardapioSemDestaque = itemCardapioRepository.findByRestaurante_IdAndDestaqueOrderByNome(restauranteId, false);
		} else {
			...
			itensCardapioSemDestaque = itemCardapioRepository.findByRestaurante_IdAndDestaqueAndCategoriaOrderByNome(restauranteId, false, categoria);
		}
